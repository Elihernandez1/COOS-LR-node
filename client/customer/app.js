...
/* Restaurant picker now lives at the homepage (client/index.html);
   this page only ever renders a specific restaurant's menu. */
...
/* ============================================================
   ENTRY POINT — no ?r= means someone landed here without picking
   a restaurant; send them to the homepage picker instead of
